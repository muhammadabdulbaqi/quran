...
#     # --- Chronological Strip Plot ---
#     st.subheader("📜 Chronological Order of Revelation")
#     fig_order, ax_order = plt.subplots(figsize=(18, 2.5))
#     sns.stripplot(
#         x='Order', y=[''] * len(df), hue='Type', data=df,
#         jitter=False, palette={'Meccan': 'blue', 'Medinan': 'green'}, size=8, ax=ax_order
#     )
#     ax_order.set_xlabel("Surah Revelation Order")
#     ax_order.set_yticks([])
#     ax_order.set_title("Chronological Surah Order by Type")
#     ax_order.legend(title='Type', loc='upper center', bbox_to_anchor=(0.5, -0.3), ncol=2)
#     st.pyplot(fig_order)
